								...
								while( ($rowBidHistory = $resBidHistory->fetch_assoc() ))
								{
									...
									echo '
										<tr>
											...
											$resBidOverNQ = $connBidHistory->query("SELECT Item_status FROM item WHERE item_id=".$rowBidHistory['Item_id']);
											...
											{
												$resBidWonNQ = $connBidHistory->query("SELECT Bidding_user_email FROM auction WHERE item_id=".$rowBidHistory['Item_id']." ORDER BY Auc_id DESC");
