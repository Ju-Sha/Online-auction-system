<?php
	...
	if($_SERVER['REQUEST_METHOD'] === "GET")
	{
		...
		{
			//$_SESSION['item_id']
			$sql = "SELECT * FROM item WHERE item_id=$_SESSION['item_id'] LIMIT 1";
...
?>
<script>
function bidTimer(str)
{
		// Set the date we're counting down to
		var countDownDate = new Date("Apr 10, 2017 17:50:25").getTime();
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>$ <?php echo $row['begin_price'] ?></span></label>
	<p id="timer" style="font-size:200%"></p>
					<div class="controls">
					<!--
